...
import com.letscode.usuarios.springmysql.converter.common.IModelConverter;
...
@Component
public class UserConverter implements IModelConverter<UserRequest, UserModel, User> {
